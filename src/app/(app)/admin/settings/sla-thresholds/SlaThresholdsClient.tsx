...
export function SlaThresholdsClient({ orgId, slaConfig: initial }: Props) {
  ...
  return (
    <div className="p-4 md:p-6 max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-xl font-bold text-slate-900">SLA Thresholds</h1>
        <p className="text-sm text-slate-500 mt-1">Set how many days a lead can stay in each stage before triggering a breach. Referral and offline leads are excluded.</p>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
        ...
        <ul className="space-y-1 text-xs list-disc list-inside">
          <li>Stage 0 (Lead Gen) has no SLA — it's the entry point</li>
          <li>Terminal stages (Closed Won, Closed Lost, Unqualified, Churn) have no SLA</li>
          <li>Referral and offline leads are excluded from all SLA breaches</li>
          <li>SLA deadline resets automatically when a lead moves to a new stage</li>
        </ul>
      </div>
